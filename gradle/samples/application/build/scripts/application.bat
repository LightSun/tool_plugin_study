...
set CLASSPATH=%APP_HOME%\lib\commons-collections-3.2.2.jar;%APP_HOME%\lib\application-1.0.2.jar

@rem Execute application
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APPLICATION_OPTS%  -classpath "%CLASSPATH%" org.gradle.sample.Main %CMD_LINE_ARGS%
