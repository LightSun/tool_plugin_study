...
//any object
        @Field(propName = "test_ResultData", type = FlowItem.class, flags = FLAGS_ALL_SCOPES),
        @Field(propName = "test_ResultData_list", type = FlowItem.class, flags = FLAGS_ALL_SCOPES, complexType = COMPLEX_LIST),
        @Field(propName = "test_ResultData_array", type = FlowItem.class, flags = FLAGS_MAIN_SCOPES, complexType = COMPLEX_ARRAY),
// sparseArray
        @Field(propName = "test_SparseArray", type = FlowItem.class,
                complexType = COMPLEX_SPARSE_ARRAY, flags = FLAGS_ALL_SCOPES),
}, maxPoolCount = 100)
public interface TestParcelableData extends IDataMediator, Parcelable, DataPools.Poolable {
    ...
    FlowItem getTest_ResultData();

    TestParcelableData setTest_ResultData(FlowItem test_ResultData1);

    List<FlowItem> getTest_ResultData_list();

    TestParcelableData setTest_ResultData_list(List<FlowItem> test_ResultData_list1);

    ListPropertyEditor<? extends TestParcelableData, FlowItem> beginTest_ResultData_listEditor();

    FlowItem[] getTest_ResultData_array();

    TestParcelableData setTest_ResultData_array(FlowItem[] test_ResultData_array1);

    SparseArray<FlowItem> getTest_SparseArray();

    TestParcelableData setTest_SparseArray(SparseArray<FlowItem> test_SparseArray1);

    SparseArrayPropertyEditor<? extends TestParcelableData, FlowItem> beginTest_SparseArrayEditor();
}
